...
function AIKO:MakeNotify(NotifyConfig)
    ...
    NotifyConfig.Title = NotifyConfig.Title or "HellZone"
...
function AIKO:Window(GuiConfig)
    ...
    GuiConfig.Title = GuiConfig.Title or "HellZone"
    GuiConfig.Footer = GuiConfig.Footer or "| made by @minsoo!"
